...
export const FormContextProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    const onSubmit = async () => {
      ...
      const memorizedValue = useMemo(() => {
        return { onSubmit, handleSubmit, register, setValue, errors, setStatus, text, setText, principalImage, setPrincipalImage, multipleFiles, onChangeMultipleFields };
      }, [errors, text, principalImage, multipleFiles])
    

    return (
        <FormContext.Provider value={memorizedValue}>
            {children}
