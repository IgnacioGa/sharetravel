...
const UpdatePost = ({ params }: { params: { slug: string } }) => {
  ...
  const { onSubmit, handleSubmit, register, setValue, errors, setStatus, text, setText, principalImage, setPrincipalImage, multipleFiles, onChangeMultipleFields} = useFormContext();
